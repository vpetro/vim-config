local tt = require('nvim-treesitter.configs')

tt.setup {
  -- "query" is necessary in order to make the query editor work in playground
  ensure_installed = {"markdown", "lua", "vimdoc", "python", "java", "scala", "json", "yaml", "query", "javascript", "typescript", "rust", "ocaml", "haskell"},
  indent = {
    enable = true,
    -- disable = {"python", "yaml"},
  },
